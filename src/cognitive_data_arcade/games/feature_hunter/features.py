...
FEATURE_BANK: list[Feature] = [
    ...
    Feature("Jakosc snu", "sleep_quality", "temporal", 0.70, 0.30, "Jakosc snu (1-10)", "Czas reakcji (ms)"),
    Feature("Czas od posilku", "time_since_meal", "temporal", -0.45, 0.40, "Czas od posilku (h)", "Czas reakcji (ms)"),
    Feature("Dzien tygodnia", "day_of_week", "temporal", 0.15, 0.52, "Dzien tygodnia (1-7)", "Czas reakcji (ms)"),
    ...
    Feature("Miesiac roku", "month", "temporal", 0.06, 0.54, "Miesiac (1-12)", "Czas reakcji (ms)"),
    # --- demographic (10) ---
    ...
    Feature("Leworecznosc", "handedness", "demographic", 0.10, 0.54, "Leworecznosc (0/1)", "Czas reakcji (ms)"),
    Feature("Liczba jezykow", "num_languages", "demographic", -0.28, 0.50, "Liczba znanych jezykow", "Czas reakcji (ms)"),
    ...
    Feature("Plec (biol.)", "sex", "demographic", -0.12, 0.52, "Plec (0=K, 1=M)", "Czas reakcji (ms)"),
    Feature("Ostrosc wzroku", "visual_acuity", "demographic", -0.30, 0.46, "Ostrosc wzroku (logMAR)", "Czas reakcji (ms)"),
    ...
    Feature("Tetno spocz.", "resting_hr", "physiological", 0.45, 0.40, "Tetno spoczynkowe (bpm)", "Czas reakcji (ms)"),
    Feature("Alkohol wczoraj", "alcohol_yesterday", "physiological", 0.50, 0.36, "Alkohol wczoraj (j.alc.)", "Czas reakcji (ms)"),
    Feature("Bol glowy", "headache", "physiological", 0.55, 0.35, "Bol glowy (0-10)", "Czas reakcji (ms)"),
    Feature("Nawodnienie", "hydration", "physiological", -0.40, 0.40, "Nawodnienie (ml/dzien)", "Czas reakcji (ms)"),
    ...
    # --- environmental (10) ---
    Feature("Poziom halasu", "noise_level", "environmental", 0.70, 0.28, "Poziom halasu (dB)", "Czas reakcji (ms)"),
    Feature("Dystraktory", "distractors", "environmental", 0.60, 0.32, "Liczba dystraktorow", "Czas reakcji (ms)"),
    Feature("CO2 (ppm)", "co2_ppm", "environmental", 0.45, 0.40, "Stezenie CO2 (ppm)", "Czas reakcji (ms)"),
    Feature("Wielozadaniowosc", "multitasking", "environmental", 0.50, 0.36, "Liczba otwartych aplikacji", "Czas reakcji (ms)"),
    Feature("Jasnosc ekranu", "screen_brightness", "environmental", -0.30, 0.46, "Jasnosc ekranu (%)", "Czas reakcji (ms)"),
    Feature("Temperatura pokoju", "room_temp", "environmental", 0.22, 0.50, "Temperatura pokoju (C)", "Czas reakcji (ms)"),
    Feature("Oswietlenie (lux)", "illuminance", "environmental", -0.26, 0.50, "Oswietlenie (lux)", "Czas reakcji (ms)"),
    Feature("Muzyka w tle (dB)", "background_music", "environmental", 0.35, 0.44, "Glosnosc muzyki (dB)", "Czas reakcji (ms)"),
    Feature("Ergonomia", "ergonomics", "environmental", -0.40, 0.40, "Ergonomia stanowiska (1-5)", "Czas reakcji (ms)"),
    Feature("Monitor Hz", "monitor_hz", "environmental", -0.16, 0.52, "Czest. odswiezania (Hz)", "Czas reakcji (ms)"),
    # --- task_history (10) ---
    Feature("Poprzedni RT", "previous_rt", "task_history", 0.80, 0.20, "Poprzedni czas reakcji (ms)", "Czas reakcji (ms)"),
    Feature("Liczba bledow", "error_count", "task_history", 0.65, 0.30, "Liczba bledow w sesji", "Czas reakcji (ms)"),
    ...
    Feature("Nr proby w bloku", "trial_number", "task_history", -0.50, 0.36, "Nr proby w bloku", "Czas reakcji (ms)"),
    Feature("Trafnosc poprzednia", "previous_accuracy", "task_history", -0.60, 0.30, "Trafnosc w poprz. bloku (%)", "Czas reakcji (ms)"),
    Feature("Calkowity trening (h)", "total_training_h", "task_history", -0.65, 0.30, "Calkowity czas treningu (h)", "Czas reakcji (ms)"),
    ...
    Feature("Liczba kotow", "cat_count", "noise", 0.03, 0.55, "Liczba kotow w domu", "Czas reakcji (ms)"),
    Feature("Znak zodiaku", "zodiac_sign", "noise", -0.02, 0.55, "Znak zodiaku (1-12)", "Czas reakcji (ms)"),
    Feature("Dlugosc imienia", "name_length", "noise", 0.01, 0.55, "Dlugosc imienia (znaki)", "Czas reakcji (ms)"),
    Feature("Gatunek filmow", "film_genre", "noise", 0.04, 0.55, "Ulubiony gatunek (kod)", "Czas reakcji (ms)"),
    Feature("Kolor wlosow", "hair_colour", "noise", -0.03, 0.55, "Kolor wlosow (kod)", "Czas reakcji (ms)"),
    ...
    Feature("Szczotkowanie zebow", "teeth_brushing", "noise", 0.03, 0.55, "Czest. szczotkowania (x/dzien)", "Czas reakcji (ms)"),
]
