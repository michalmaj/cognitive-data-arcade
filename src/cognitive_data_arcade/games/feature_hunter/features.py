...
FEATURE_BANK: list[Feature] = [
    ...
    Feature(
        ...
        -0.32,
        0.46,
        "Pora ostatniego treningu (h temu)",
        "Czas reakcji (ms)",
...
def draw_features(
    ...
    signals = [f for f in FEATURE_BANK if abs(f.correlation) >= difficulty.min_signal_correlation]
    noises = [f for f in FEATURE_BANK if abs(f.correlation) <= difficulty.max_noise_correlation]
