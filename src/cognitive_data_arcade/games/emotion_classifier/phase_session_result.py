...
class PhaseSessionResultScene(Scene):
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        surface.blit(play_lbl, (play_btn.centerx - play_lbl.get_width() // 2, play_btn.centery - play_lbl.get_height() // 2))
    ...
    def _draw_bar_chart(self, surface: pygame.Surface, top: int) -> None:
        ...
        for pct in (0, 25, 50, 75, 100):
            ...
            surface.blit(pct_lbl, (chart_x - pct_lbl.get_width() - 4, y - pct_lbl.get_height() // 2))
        ...
        for i, cat in enumerate(_CATEGORIES):
            ...
            if total > 0:
                ...
                surface.blit(pct_text, (bx + bar_w // 2 - pct_text.get_width() // 2, max(top + 10, by - 14)))
