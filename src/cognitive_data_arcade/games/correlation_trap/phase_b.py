...
class PhaseBScene(Scene):
    ...
    def _build_button_rects(self) -> None:
        self._btn_rects = [pygame.Rect(_BTN_POSITIONS[i], _BTN_Y, _BTN_W, _BTN_H) for i in range(3)]
