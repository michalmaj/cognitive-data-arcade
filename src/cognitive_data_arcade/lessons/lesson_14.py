...
CONTENT: dict[str, dict[str, list[str]]] = {
    "pl": {
        "theory": [
            ...
            "Spurious Correlations - Tyler Vigen (2015) stworzył stronę internetową, na której automatycznie wyszukuje korelacje między przypadkowymi zmiennymi z danych rządowych USA. Spożycie sera na głowę koreluje ze śmiercią przez zaplątanie w pościel (r=0.947). Strona stała sie podręcznikowym przykładem korelacji spuriousowych.",
            "Jak ustalamy przyczynowość? Złotym standardem jest eksperyment z randomizacją (RCT). Bez randomizacji używa sie badań naturalnych, regresji z kontrolą zmiennych ukrytych lub kryteriów Bradforda-Hilla (1965) - 9 kryteriów opracowanych po epidemiologicznych badaniach nad związkiem palenia z rakiem płuca.",
        ...
        "tasks": [
            "W Fazie A: ustaw r=0.9, N=20 i r=0.9, N=200. Jak różni sie wygląd chmury punktów? Teraz utrzymaj r=0.9, N=200 i zwiększ szum do 0.8. Jak zmieniło sie wizualne wrażenie? Czy r sie zmieniło?",
            "W Fazie B: przejdź przez wszystkie 8 scenariuszy. Dla każdego spurious - znajdź zmienną ukrytą zanim klikniesz 'Poddaj sie'. Dla każdego causal - zastanów sie jak można to sprawdzić eksperymentalnie.",
