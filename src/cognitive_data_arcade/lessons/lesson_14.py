...
CONTENT: dict[str, dict[str, list[str]]] = {
    "pl": {
        "theory": [
            ...
            "Klasyczna korelacja pozorna: spożycie lodów koreluje z liczbą utonięć (r=0.88), bo wspólna przyczyna to pora roku - latem ludzie jedzą więcej lodów i więcej pływają. Korelacja przyczynowa: palenie papierosów i rak płuc, potwierdzone w setkach badań kohortowych i eksperymentów na zwierzętach.",
        ],
        "notes": [
