...
CONTENT: dict[str, dict[str, list[str]]] = {
    "pl": {
        "theory": [
            ...
            "Trzy podejścia do selekcji cech: (1) Filter methods - oceniają cechy niezależnie od modelu (korelacja, test chi², ANOVA). (2) Wrapper methods - testują podzbiory cech przez trenowanie modelu. (3) Embedded methods - algorytm uczy sie i wybiera cechy jednocześnie (LASSO, drzewa decyzyjne).",
