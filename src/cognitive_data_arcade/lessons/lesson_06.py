...
CONTENT: dict[str, dict[str, list[str]]] = {
    "pl": {
        "theory": [
            "Eksploracyjna analiza danych (EDA, Tukey 1977) to badanie struktury danych przed testowaniem hipotez. Chodzi o wykrycie anomalii, zrozumienie rozkładów i znalezienie wzorców. EDA generuje hipotezy - nie testuje ich.",
            "Mediana to preferowana miara centralna dla RT, bo jest odporna na wartości skrajne. SD opisuje rozrzut, ale jest wrażliwe na outliery. IQR (Q3 - Q1) jest odporny na ogon rozkładu. Skośność surowego RT jest prawie zawsze dodatnia.",
        ...
        "notes": [
            "Na początku zajęć daj studentom dwie liczby (średnie RT dla dwóch warunków) i zapytaj, czy różnica jest realna. Potem pokaż, że te same liczby mogą opisywać zupełnie inną sytuację zależnie od kształtu rozkładu.",
