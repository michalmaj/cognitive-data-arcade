...
CONTENT: dict[str, dict[str, list[str]]] = {
    "pl": {
        "theory": [
            "Przeszukiwanie wzrokowe to zdolność do znajdowania celu wśród dystraktorów. Na co dzień robi się to setki razy - szukanie klucza na zawalonym biurku, twarzy znajomego w tłumie, ikony w aplikacji. Czas reakcji mówi, jak system wzrokowy przetwarza scenę.",
        ...
        "notes": [
            ...
            "Asymetria poszukiwania - znalezienie prostej linii wśród skrzyżowanych jest łatwiejsze niż znalezienie skrzyżowanej wśród prostych. Cechy 'niezwykłe' wyróżniają się mocniej niż 'zwykłe'. To asymetria wykrywania cech.",
        ...
        "tasks": [
            "Porównaj wyniki: o ile ms dłużej trwało przeszukiwanie złożone niż cechowe? Sprawdź też dokładność - czy w jednym warunku pojawia się więcej błędów?",
