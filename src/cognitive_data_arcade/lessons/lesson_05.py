...
CONTENT: dict[str, dict[str, list[str]]] = {
    "pl": {
        "theory": [
            ...
            "Algorytm MICE (Multiple Imputation by Chained Equations) - van Buuren i Groothuis-Oudshoorn, 2011. Każda zmienna z brakami jest imputowana osobno za pomocą modelu regresji na pozostałych zmiennych. Pakiet R 'mice' ma ponad 500 000 pobrań miesięcznie i stał się de facto standardem w naukach społecznych.",
