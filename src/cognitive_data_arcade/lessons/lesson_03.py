...
CONTENT: dict[str, dict[str, list[str]]] = {
    "pl": {
        "theory": [
            "Log zdarzeń to opatrzony znacznikiem czasu rejestr dyskretnych zdarzeń podczas eksperymentu: pojawienie sie bodźca, naciśniecie klawisza, dostarczenie informacji zwrotnej. Każdy eksperyment behawioralny generuje taki log - Donders robił to ręcznie w 1868 roku; dziś robi sie to automatycznie z precyzją milisekundową.",
            ...
            "Częstotliwości próbkowania i precyzja: EEG przy 1000 Hz rejestruje co 1 ms - wystarczająco do rozróżnienia P100 od N200. Standardowe odpytywanie klawiatury USB odbywa sie co 8 ms. To jest granica precyzji pomiaru RT na typowym sprzęcie konsumenckim - efekt o wielkości 10 ms jest statystycznie nieinterpretowalny.",
        ...
        "notes": [
            "Czytelność kontra rozmiar - CSV otwiera sie w Excelu, ale plik CSV z 10 milionami wierszy zablokuje komputer. HDF5 jest nieczytelny dla człowieka, ale obsługuje terabajty bez utraty wydajności. Dobry format to taki, który pasuje do rozmiaru i struktury danych.",
            "RT wewnątrz urządzenia kontra między urządzeniami - RT obliczony na jednym komputerze (czas upływający od bodźca do odpowiedzi na tej samej maszynie) jest wewnętrznie spójny. Problem pojawia sie tylko przy wyrównywaniu logów z dwóch różnych systemów, np. logu behawioralnego i EEG.",
