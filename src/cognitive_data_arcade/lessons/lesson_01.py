...
REFLECTION = {
    "pl": {
        "title": "Big Data w Kognitywistyce — Refleksja",
        "cards": [
            {
                "label": "Skala",
                "color": "indigo",
                "text": "Big data to nie gigabajty, to miliardy wierszy generowane przez miliony użytkowników jednocześnie — skala niemożliwa w tradycyjnym laboratorium.",
            },
            {
                "label": "Narzędzie",
                "color": "orange",
                "text": "Kognitywistyka dostarcza paradygmaty eksperymentalne; big data pozwala replikować je w skali i różnorodności populacji nieosiągalnej w laboratorium.",
            },
            {
                "label": "Wyzwanie",
                "color": "green",
                "text": "Więcej danych ≠ lepsze dane. Jakość, reprezentatywność i etyka zbierania są ważniejsze niż sam wolumen.",
            },
        ],
        "question": "Która platforma cyfrowa generuje więcej danych behawioralnych niż wszystkie laboratoria psychologiczne razem wzięte — i dlaczego to jest jednocześnie szansa i problem?",
    },
    "en": {
        "title": "Big Data in Cognitive Science — Reflection",
        "cards": [
            {
                "label": "Scale",
                "color": "indigo",
                "text": "Big data is not gigabytes — it is billions of rows generated by millions of users simultaneously, a scale impossible in a traditional lab.",
            },
            {
                "label": "Tool",
                "color": "orange",
                "text": "Cognitive science provides experimental paradigms; big data lets us replicate them at population scale and diversity unreachable in a lab.",
            },
            {
                "label": "Challenge",
                "color": "green",
                "text": "More data does not mean better data. Quality, representativeness, and collection ethics matter more than raw volume.",
            },
        ],
        "question": "Which digital platform generates more behavioural data than all psychology labs combined — and why is that both an opportunity and a problem?",
    },
}
