...
CONTENT: dict[str, dict[str, list[str]]] = {
    "pl": {
        "theory": [
            ...
            "Miller (1956) - w artykule 'The Magical Number Seven, Plus or Minus Two' George Miller wykazał, że pojemność pamięci krótkotrwałej wynosi ok. 7 elementów (plus minus 2). Cowan (2001) zrewidował tę liczbę do ok. 4 porcji informacji (chunks), gdy zapobiega sie powtarzaniu. Różnica wynika z tego, że Miller liczył elementy, a Cowan - porcje po grupowaniu.",
            "Model Baddeleya - pamięć robocza składa sie z pętli fonologicznej (dźwięki i słowa), szkicownika wzrokowo-przestrzennego (obrazy i lokalizacje) i centralnego wykonawcy (koordynacja). Dual N-Back angażuje pierwsze dwa składniki jednocześnie.",
