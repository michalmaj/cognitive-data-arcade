...
CONTENT: dict[str, dict[str, list[str]]] = {
    "pl": {
        "theory": [
            ...
            "Asymetria spreader vs fact-checker wynika z dwóch efektów: spreader działa ekspansywnie (każdy zarażony tworzy nowych zarażonych), a fact-checker działa zastępczo (jeden klik leczy tylko jeden węzeł, a SIR nie zatrzymuje się). W sieci bezskalowej asymetria jest dramatycznie większa niż w sieci losowej.",
