...
EN = Strings(
    ...
    lesson_reader_play_hint="ENTER  play",
...
PL = Strings(
    language="pl",
    menu_title="Cognitive Data Arcade",
    menu_subtitle="UP/DN  nawigacja   O  opcje   T  teoria   P  profil   L  język: PL   ESC  wyjście",
    ...
    eld_consequence_fmt="Jeżeli wybierzesz {label}:",
