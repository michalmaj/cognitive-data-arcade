...
class GoNoGoLevelScene(Scene):
    ...
    def _launch(self) -> None:
        ...
        csv_path = self._pm.paths.generated_data_dir / "gono" / f"{sid}.csv"
        inner = GoNoGoGame(config, self._pm, self._strings, pid, sid, csv_path)
        ...
        self._next = make_how_to_play(
            ...
            self._strings,
            back_scene=pausable,
            esc_scene=GoNoGoLevelScene(self._pm, self._strings),
        )
        self._done = True
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        # Title
        title = self._font_title.render("Go/No-Go", True, _WHITE)
        ...
        session_descs = [
            f"40 {self._strings.level_trials_suffix}",
            f"80 {self._strings.level_trials_suffix}",
            f"120 {self._strings.level_trials_suffix}",
        ]
        ...
        diff_descs = [
            self._strings.gono_easy_desc,
            self._strings.gono_medium_desc,
            self._strings.gono_hard_desc,
        ]
