...
def test_engine_raw_tokens_always_whitespace_split():
    ...
    eng = TokenizerEngine()
    state = eng.process(
        "Hello, world! HELLO", lowercase=True, rm_punct=True, rm_stops=False, lang="en", ngram_n=1
    )
...
def test_engine_lowercase_and_rm_punct():
    ...
    eng = TokenizerEngine()
    state = eng.process(
        "Hello, World!", lowercase=True, rm_punct=True, rm_stops=False, lang="en", ngram_n=1
    )
...
def test_engine_rm_stops_en():
    ...
    eng = TokenizerEngine()
    state = eng.process(
        "the cat is on the mat", lowercase=True, rm_punct=False, rm_stops=True, lang="en", ngram_n=1
    )
...
def test_engine_rm_stops_pl():
    ...
    eng = TokenizerEngine()
    state = eng.process(
        "badanie wykazalo ze czas reakcji wzrosl",
        lowercase=True,
        rm_punct=False,
        rm_stops=True,
        lang="pl",
...
def test_engine_bigrams():
    ...
    eng = TokenizerEngine()
    state = eng.process(
        "czas reakcji wzrosl", lowercase=False, rm_punct=False, rm_stops=False, lang="pl", ngram_n=2
    )
...
def test_engine_trigrams():
    ...
    eng = TokenizerEngine()
    state = eng.process(
        "a b c d", lowercase=False, rm_punct=False, rm_stops=False, lang="en", ngram_n=3
    )
...
def test_engine_freq_sorted():
    ...
    eng = TokenizerEngine()
    state = eng.process(
        "a a a b b c", lowercase=False, rm_punct=False, rm_stops=False, lang="en", ngram_n=1
    )
...
def test_engine_unique_count():
    ...
    eng = TokenizerEngine()
    state = eng.process(
        "a b a c", lowercase=False, rm_punct=False, rm_stops=False, lang="en", ngram_n=1
    )
