...
def test_game_factory_for_16_returns_callable(tmp_path):
    ...
    factory = scene._game_factory_for(16)
    assert callable(factory), "_game_factory_for(16) must return a callable"
